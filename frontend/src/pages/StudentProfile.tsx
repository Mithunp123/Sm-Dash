...
import { ArrowLeft, Save, UserCircle, Camera, Settings, X, AlertCircle } from "lucide-react";
            ...
            <div className="mb-6 bg-orange-50 dark:bg-orange-950/30 border border-orange-200 dark:border-orange-900 rounded-lg p-4 flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-orange-800 dark:text-orange-300">
                  You must change your password first before you can create or update your profile. Please go to the "Account Settings" tab and change your password.
                </p>
              </div>
            </div>
          )}
